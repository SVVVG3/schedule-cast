...
export default function ModernCastForm() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500 via-violet-500 to-indigo-500 p-[1px] shadow-2xl">
        <div className="rounded-2xl bg-white p-6 sm:p-8">
          {/* Header */}
          <div className="mb-6 text-center">
            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-indigo-500">
              <svg
            ...
            <h2 className="text-2xl font-bold text-gray-900">Schedule a Cast</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-3 right-3 text-xs font-medium">
                  <span className={characterCount >= 320 ? 'text-red-500' : characterCount >= 280 ? 'text-yellow-500' : 'text-gray-400'}>
                    {characterCount}/320
                  </span>
                </div>
              </div>
            ...
            <button
              ...
              className="w-full rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 px-6 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-200 hover:from-purple-600 hover:to-indigo-700 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            >
              {isSubmitting ? (
