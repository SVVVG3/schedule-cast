         ...
         <div className="mt-12 text-center">
           <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
             <div className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
               <div className="w-12 h-12 bg-purple-900 rounded-lg flex items-center justify-center mx-auto mb-4 flex-shrink-0 border border-purple-700">
                 <svg className="w-6 h-6 text-purple-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="24" height="24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                 </svg>
               </div>
               <h3 className="font-semibold text-white mb-2">Perfect Timing</h3>
               <p className="text-sm text-gray-300">Schedule casts for any future date and time</p>
             </div>
             ...
             <div className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
               ...
               <h3 className="font-semibold text-white mb-2">Channel Support</h3>
               <p className="text-sm text-gray-300">Post to specific channels or your main feed</p>
             </div>
             ...
             <div className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
               ...
               <h3 className="font-semibold text-white mb-2">Track & Manage</h3>
               <p className="text-sm text-gray-300">Monitor your scheduled and posted casts</p>
             </div>
           </div>
         </div>
